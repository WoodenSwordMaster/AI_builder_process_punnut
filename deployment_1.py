    ...
    if click == True:
        with st.spinner('Waiting for AI to diagnosis...'):
            if uploaded_file is not None:
                ...
                upper = 1
                lower = 0
                nii_img = np.where(nii_img > th, upper, lower)
                ...
                if predicted == 0:
                    ...
                    st.subheader("This brain has a: Forgetfulness of elderly people that can develop into Alzheimer disease in the future")
                else:
