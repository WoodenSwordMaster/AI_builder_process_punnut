...
data_path = r"C:\Users\punnut\Downloads\final_dataset+AD_1_preprocessed3_traintest_64"
AD_class_train = []
CN_class_train = []
MCI_class_train = []
MCI_AD_class_train = []
...
def transform_images_dataset(data):
    ...
    data = data.reshape(1, 1, 64, 64, 64)
    ...
    for i, (images, labels) in tqdm(enumerate(train_loader)):
        ...
        if itr % 50 == 0:
            ...
            for images, labels in val_loader:
                ...
                #print("loss2", loss.item() * images.size(0))
            ...
            print('Iteration: {}  Loss: {}  Accuracy: {} %'.format(itr, loss, accuracy))
...
torch.save(model.state_dict(), r'C:\Users\punnut\Downloads\saved_model+AD_2.pth')
